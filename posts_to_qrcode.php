...
function my_textbox_callback($args) {  // Textbox Callback
    $option = get_option('option_1');
    echo '<input type="text" id="option_1" name="option_1" value="' . $option . '" />';
}
function my_textbox_callback2($args) {  // Textbox Callback
    $option = get_option('option_2');
    echo '<input type="text" id="option_2" name="option_2" value="' . $option . '" />';
}
